            ...
            <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
              <div className="flex items-center justify-center pl-0 sm:justify-start md:pl-1">
                <p className="font-body text-lg  text-white">
                  ...
                  University, which has given me experience in a breadth of
                  coding languages and a solid foundation for computing skills.
                  I am currently completing edX's full stack developer course in
                  order to hone my skills with regards to developing web
                  applications with hands-on experience. Throughoug my coding
                  journey, I have gained experience in JavaScript, HTML, CSS,
                  PostgreSQL, as well as Java and Python. Recently, I have been
                  creating projects using Node.js, MongoDB, React, and
                  TailwindCSS. I love tackling challenging problems and learning
                  about new technologies, and I am passionate about
