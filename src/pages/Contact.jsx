...
<div className="container py-16 md:py-20" id="contact">
  <h2
    className="text-center font-header text-4xl font-semibold uppercase"
  >
    Let's get in touch!
  </h2>
  <form className="group mx-auto w-full pt-10 sm:w-3/4">
    ...
    ></textarea>
    <button
      className="mt-6 flex items-center justify-center rounded bg-darkest px-8 py-3 font-header text-lg font-bold uppercase text-white hover:bg-mid group-invalid:pointer-events-none group-invalid:opacity-30"
    >
      Send
  ...
  <h2
    className="text-center font-header text-2xl font-semibold uppercase"
  >
    Or, send me an email: <span className="lowercase text-slate-600">oliviatekolste@gmail.com</span>
  </h2>
</div>
    );
  }
